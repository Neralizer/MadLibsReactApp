    ...
    render(){
        ...
        return (
            <div className={data.completedForm ? 'showContent' : 'hideContent'}>
                ...
                order to find true <label className="black-label">12</label>{this.renderLabel(data.nounTwo)} again. Just as everything seemed hopeless, out from the palm trees
                ...
                of the car. Still, <label className="black-label">2</label>{this.renderLabel(data.celebOne)} felt better and drove off.
                </div>
            </div>
        )
        }
